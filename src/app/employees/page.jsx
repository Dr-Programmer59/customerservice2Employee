        ...
        <div>
            <div className='header py-2 shadow-md flex items-center justify-between px-4'>
                <div className='flex items-center gap-3'>
                    ...
                    <img class="rounded-full w-16 h-16" src="https://res.cloudinary.com/dc6deairt/image/upload/v1638102932/user-32-01_pfck4u.jpg" />
                    <div>
                        <h2 className='text-gray-800'>{customerNumber.customerNumber}</h2>
                        <p className='text-gray-500 text-[6px] md:text-sm'>The video chat ended · 2hrs</p>
                    </div>
